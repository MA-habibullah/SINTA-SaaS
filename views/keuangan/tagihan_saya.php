...
<div id="keuangan-tagihan-saya-app" v-cloak class="container-fluid px-4 py-4">
    ...
    <div class="card border-0 shadow-sm rounded-4 p-4 bg-white">
        <h5 class="fw-bold text-slate-800 mb-3">Rincian <?php echo htmlspecialchars($customTagihanTerm); ?></h5>
            ...
            <table class="table table-hover align-middle">
                ...
                <tbody>
                    <tr v-for="t in tagihanList" :key="t.id">
                        ...
                        <td>
                            <span class="badge px-3 py-2 rounded-pill" :class="getStatusBadgeClass(t.status_lunas)">
                                {{ t.status_lunas }}
                            </span>
                        </td>
                    </tr>
