        ...
        <div class="col-12 col-lg-7 mx-auto">
            ...
            <div class="d-flex align-items-center justify-content-between mb-4">
                <div>
                    ...
                    <p class="text-muted mb-0">Terbitkan tagihan sumbangan, iuran buku, atau SPP ke banyak siswa sekaligus secara aman.</p>
                </div>
            </div>
            ...
            <div class="card border-0 shadow-sm rounded-4 bg-white p-4">
                <!-- Informational Alert -->
                <div class="p-3 bg-light rounded-3 text-muted fs-7 mb-4">
                ...
                <form @submit.prevent="generateTagihan">
                    <!-- Komponen Biaya -->
                    <div class="mb-3">
                        <label class="form-label fw-semibold text-slate-700">Komponen Biaya <span class="text-danger">*</span></label>
                        <select class="form-select border-slate-200" v-model="form.komponen_id" @change="onKomponenChange" required>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <select class="form-select border-slate-200" v-model="form.tahun_ajaran_id" required>
                        ...
                        <div class="col-md-6 mb-3" v-if="isBulanan">
                            <label class="form-label fw-semibold text-slate-700">Pilih Bulan Tagihan <span class="text-danger">*</span></label>
                            <select class="form-select border-slate-200" v-model="form.bulan" required>
                    ...
                    <div class="mb-4">
                        ...
                        <div class="d-flex gap-3 mb-3">
                            <div class="form-check">
                                ...
                                <label class="form-check-label text-slate-700" for="targetAll">Semua Kelas</label>
                            </div>
                            <div class="form-check">
                                ...
                                <label class="form-check-label text-slate-700" for="targetKelas">Per Kelas</label>
                            </div>
                            <div class="form-check">
                                ...
                                <label class="form-check-label text-slate-700" for="targetJenjang">Per Jenjang</label>
                            </div>
                        </div>
                        ...
                        <div class="mb-3" v-if="targetType === 'kelas'">
                            ...
                            <select class="form-select border-slate-200" v-model="form.kelas_id" required>
                        ...
                        <div class="mb-3" v-if="targetType === 'jenjang'">
                            ...
                            <select class="form-select border-slate-200" v-model="form.jenjang_id" required>
