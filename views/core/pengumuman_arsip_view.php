        ...
        <div class="col-12 px-1 px-md-3">
            <div class="d-flex flex-column flex-md-row justify-content-between align-items-md-center gap-3">
                <div class="d-flex align-items-center gap-3">
                    <a href="<?= $this->getBaseUrl() ?>/dashboard" class="btn btn-light rounded-circle shadow-sm" style="width: 45px; height: 45px; display: flex; align-items: center; justify-content: center;">
                ...
                <form method="GET" action="<?= $this->getBaseUrl() ?>/pengumuman/arsip" class="d-flex flex-wrap gap-2 w-100 mt-3 mt-md-0" style="max-width: 800px;">
                    ...
                    <?php if (!empty($search) || !empty($kategori) || !empty($tanggal)): ?>
                        <a href="<?= $this->getBaseUrl() ?>/pengumuman/arsip" class="btn btn-light rounded-pill px-3 border shadow-sm text-danger" title="Reset Filter"><i class="bi bi-x-lg"></i></a>
                    <?php endif; ?>
                </form>
            </div>
        </div>
                            ...
                            <div class="card border border-light-subtle shadow-sm rounded-3">
                                <div class="card-body p-2 p-md-3">
                                    ...
                                    <div class="mt-3 pt-2 border-top">
                                        <?php if ($isImage): ?>
                                            <div class="mb-2 rounded-3 overflow-hidden shadow-sm" style="max-height: 150px; cursor: pointer; max-width: 250px;" onclick="window.open('<?= $this->getBaseUrl() ?>/storage/app/public/<?= htmlspecialchars($pengumuman['lampiran_file']) ?>', '_blank')">
                                                <img src="<?= $this->getBaseUrl() ?>/storage/app/public/<?= htmlspecialchars($pengumuman['lampiran_file']) ?>" class="w-100 h-100 object-fit-cover hover-zoom" alt="Lampiran Pengumuman">
                                            </div>
                                        <?php endif; ?>
                                        <a href="<?= $this->getBaseUrl() ?>/storage/app/public/<?= htmlspecialchars($pengumuman['lampiran_file']) ?>" target="_blank" class="btn btn-primary fw-semibold d-flex d-md-inline-flex justify-content-center align-items-center rounded-3 px-3 py-1 shadow-sm w-100 w-md-auto" style="font-size: 0.8rem; transition: all 0.2s ease;">
