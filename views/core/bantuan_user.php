                        ...
                        <div class="col-md-5 border-end p-4 bg-light-subtle d-flex flex-column" style="overflow-y: auto; height: 100%;">
                            <div v-if="activeTicket">
                                ...
                                <div class="mb-3" v-if="activeTicket.lampiran">
                                    <a :href="'<?= $this->getBaseUrl() ?>' + activeTicket.lampiran" target="_blank" class="d-block border rounded-3 p-1 bg-white hover-zoom shadow-sm text-center">
                                        <img :src="'<?= $this->getBaseUrl() ?>' + activeTicket.lampiran" class="img-fluid rounded-2" style="max-height: 140px;" alt="Lampiran Laporan">
...
window.VueAppRegistry.register('#bantuan-user-app', {
    ...
    methods: {
        ...
        fetchUnreadCount() {
            axios.get('<?= $this->getBaseUrl() ?>/api/v1/bantuan/unread-count')
            .then(res => {
                if (res.data.success) {
        ...
        faqLookup() {
            ...
            axios.get('<?= $this->getBaseUrl() ?>/api/v1/bantuan/faq-lookup', { params: { q } })
            .then(res => {
                if (res.data.success) {
        ...
        submitTicket() {
            ...
            axios.post('<?= $this->getBaseUrl() ?>/api/v1/bantuan/buat', formData, {
        ...
        submitReply() {
            ...
            axios.post('<?= $this->getBaseUrl() ?>/api/v1/bantuan/balas', {
