                            ...
                            <div v-if="activeTicket">
                                ...
                                <div class="mb-3" v-if="activeTicket.lampiran">
                                    <a :href="'<?= $this->getBaseUrl() ?>' + activeTicket.lampiran" target="_blank" class="d-block border rounded-3 p-1 bg-white hover-zoom shadow-sm text-center">
                                        <img :src="'<?= $this->getBaseUrl() ?>' + activeTicket.lampiran" class="img-fluid rounded-2" style="max-height: 120px;" alt="Lampiran Laporan">
...
window.VueAppRegistry.register('#bantuan-admin-app', {
    ...
    methods: {
        ...
        updateTicketStatus() {
            ...
            axios.post('<?= $this->getBaseUrl() ?>/api/v1/bantuan/update-status', {
