        ...
        setup() {
            ...
            const loadSchoolIdentity = async () => {
                try {
                    ...
                    const response = await axios.get(`<?= $this->getBaseUrl() ?>/sekolah/identitas?ajax=1&action=get_tenant_detail&id=${tId}`);
            ...
            const checkNpsnUnique = () => {
                ...
                npsnTimeout = setTimeout(async () => {
                    try {
                        const response = await axios.get('<?= $this->getBaseUrl() ?>/api/v1/tenant/check-npsn', {
                            params: {
                                npsn: form.npsn,
            ...
            const submitForm = async () => {
                ...
                try {
                    const response = await axios.post('<?= $this->getBaseUrl() ?>/api/v1/tenant/update', {
