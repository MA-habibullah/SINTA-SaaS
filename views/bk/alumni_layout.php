                    ...
                    <div>
                        <div class="d-flex align-items-center gap-2 mb-2 flex-wrap">
                            <span class="badge px-3 py-1.5 rounded-pill text-xs font-semibold d-inline-flex align-items-center gap-1.5" style="background: rgba(255,255,255,0.18); backdrop-filter: blur(8px); border: 1px solid rgba(255,255,255,0.25);">
                                <i class="bi bi-mortarboard-fill text-amber-300"></i> Penelusuran Karir & Portofolio Alumni
                            </span>
                        </div>
                        <h2 class="h3 font-bold text-white mb-1 tracking-tight">Alumni & Tracer Study</h2>
                        <p class="text-white/85 text-xs mb-0" style="max-width: 680px; line-height: 1.6;">
                            Manajemen penelusuran karir, portofolio kelanjutan studi perguruan tinggi, dan riwayat pekerjaan alumni terpusat.
                        </p>
                    </div>
