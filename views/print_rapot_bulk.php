            ...
            <div class="signature-left">
                <?php if (isset($showQrCode) && $showQrCode && isset($baseVerifyUrl)): ?>
                    <div style="text-align: center; border: 1px solid #ccc; padding: 5px; border-radius: 4px; display: inline-block; background-color: #fff; width: 85px;">
                        ...
                        <img src="https://api.qrserver.com/v1/create-qr-code/?size=75x75&data=<?= urlencode($baseVerifyUrl . $siswa['id']) ?>" alt="QR Code" style="width: 75px; height: 75px; display: block; margin: 0 auto;">
                    </div>
                <?php endif; ?>
            </div>
