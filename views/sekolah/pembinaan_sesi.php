<div class="container-fluid px-4 py-4">
    <div class="mb-6 flex items-center justify-between">
        ...
        <a href="<?= $this->getBaseUrl() ?>/pembinaan<?= $tenantParam ?>" class="btn bg-slate-100 hover:bg-slate-200 text-slate-700 font-semibold rounded-xl">
    ...
    <div class="row g-4">
        ...
        <div class="col-12 col-lg-8">
            <div class="glass-card rounded-3xl p-6">
                <form action="<?= $this->getBaseUrl() ?>/pembinaan/sesi/simpan" method="POST" id="formSesi">
