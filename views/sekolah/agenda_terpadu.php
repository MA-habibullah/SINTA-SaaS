...
<div class="container-fluid py-4 bg-slate-50 min-h-screen font-sans">
    ...
    <div class="flex flex-col md:flex-row justify-between items-start md:items-center mb-8 gap-4">
        ...
        <div class="flex flex-wrap gap-3 items-center">
            <!-- Filter Form -->
            <form method="GET" action="<?= $this->getBaseUrl() ?>/informasi/agenda" class="m-0 flex flex-wrap gap-2 items-center bg-white p-1 rounded-2xl shadow-sm border border-slate-100 w-full md:w-auto justify-center md:justify-start">
                <?php if ($isSuperAdmin): ?>
                                ...
                                <tr class="hover:bg-slate-50 transition-colors group">
                                    ...
                                    <td class="py-4 text-center">
                                        <div class="flex justify-center gap-2">
                                            ...
                                            <form action="<?= $this->getBaseUrl() ?>/informasi/agenda/delete" method="POST" class="m-0" onsubmit="return confirm('Hapus kegiatan ini secara permanen?');">
...
<div class="modal fade" id="addAgendaModal" tabindex="-1">
    <div class="modal-dialog modal-lg modal-dialog-scrollable">
        <form action="<?= $this->getBaseUrl() ?>/informasi/agenda/store" method="POST" enctype="multipart/form-data" id="formAgenda">
...
<div class="modal fade" id="addKategoriModal" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content" style="border-radius: 12px; border: none;">
            ...
            <form action="<?= $this->getBaseUrl() ?>/informasi/kategori-agenda/store" method="POST">
                <div class="modal-body p-4">
                    <div class="mb-3">
...
<div class="modal fade" id="editKategoriModal" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content" style="border-radius: 12px; border: none;">
            ...
            <form action="<?= $this->getBaseUrl() ?>/informasi/kategori-agenda/update" method="POST">
...
<!-- Form Hapus Hidden -->
<form id="deleteKategoriForm" action="<?= $this->getBaseUrl() ?>/informasi/kategori-agenda/delete" method="POST" style="display: none;">
...
function initAgendaTerpadu() {
    ...
    axios.get(`<?= $this->getBaseUrl() ?>/informasi/agenda?ajax=1&action=get_agenda_data&filter_tenant_id=${filterTenantId}`)
        .then(response => {
