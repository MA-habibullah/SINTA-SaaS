...
foreach ($mapelData as $k => $v) {
    ...
    if ($count > 0) {
        $mapelData[$k]['rata'] = round($sum / $count);
    }
}
?>
<!DOCTYPE html>
    ...
    <table class="data-table">
        <thead>
            <tr>
                ...
                <th colspan="6">Nilai Semester</th>
        ...
        <tbody>
            ...
            foreach ($mapelData as $name => $data) {
                ...
                echo "<td>{$data['s5']}</td>";
                echo "<td>{$data['s6']}</td>";
                echo "<td><b>{$data['rata']}</b></td>";
                echo "</tr>";
                $no++;
            }
            if (empty($mapelData)) {
                echo "<tr><td colspan='9'>Belum ada data nilai tercatat.</td></tr>";
            }
            ?>
        </tbody>
    </table>
