...
<div class="container-fluid py-4">
    ...
    <div class="tab-content" id="ekskulTabContent">
                            ...
                            <tbody>
                                ...
                                <?php else: ?>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <form action="<?= $this->getBaseUrl() ?>/api/v1/ekskul/toggle-status<?= $is_super_admin ? '?tenant_id=' . urlencode($selected_tenant) : '' ?>" method="POST" class="d-inline">
                            ...
                            <tbody>
                                ...
                                <?php else: ?>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <form action="<?= $this->getBaseUrl() ?>/api/v1/ekskul/pembina/toggle-status<?= $is_super_admin ? '?tenant_id=' . urlencode($selected_tenant) : '' ?>" method="POST" class="d-inline">
            ...
            <div class="card shadow-sm border-0 rounded-4 mb-4">
                <div class="card-body p-4">
                    ...
                    <div class="d-flex flex-wrap justify-content-between align-items-center gap-2">
                        ...
                        <?php if ($can_lock): ?>
                            <form action="<?= $this->getBaseUrl() ?>/api/v1/ekskul/kunci/anggota" method="POST" class="mb-0">
                    ...
                    <div class="col-lg-7 mb-4">
                        <div class="card shadow-sm border-0 rounded-4 overflow-hidden h-100">
                            <div class="card-header bg-white border-bottom-0 py-3 d-flex justify-content-between align-items-center flex-wrap gap-2">
                                ...
                                <a href="<?= $this->getBaseUrl() ?>/api/v1/ekskul/anggota/export?ekskul_id=<?= urlencode($selected_ekskul_id) ?>&semester=<?= urlencode($selected_semester) ?>&tahun_ajaran_id=<?= urlencode($active_ta['id']) ?><?= $is_super_admin ? '&tenant_id=' . urlencode($selected_tenant) : '' ?>" class="btn btn-sm btn-outline-success rounded-3" title="Ekspor rekap anggota ke Excel">
                                            ...
                                            <?php else: ?>
                                                <?php foreach($current_members as $member): ?>
                                                    <tr>
                                                        ...
                                                        <td class="text-center pe-4">
                                                            <form action="<?= $this->getBaseUrl() ?>/api/v1/ekskul/anggota/hapus<?= $is_super_admin ? '?tenant_id=' . urlencode($selected_tenant) : '' ?>" method="POST" class="d-inline" onsubmit="return confirm('Keluarkan <?= htmlspecialchars(addslashes($member['nama_lengkap'])) ?> dari ekstrakurikuler ini?');">
                    ...
                    <div class="col-lg-5 mb-4">
                        <div class="card shadow-sm border-0 rounded-4 overflow-hidden h-100">
                            ...
                            <div class="card-body p-3">
                                ...
                                <form action="<?= $this->getBaseUrl() ?>/api/v1/ekskul/anggota/tambah<?= $is_super_admin ? '?tenant_id=' . urlencode($selected_tenant) : '' ?>" method="POST" id="form_tambah_anggota">
                                    <input type="hidden" name="ekskul_id" value="<?= htmlspecialchars($selected_ekskul_id) ?>">
                                    <input type="hidden" name="tahun_ajaran_id" value="<?= htmlspecialchars($active_ta['id'] ?? '') ?>">
                                    <input type="hidden" name="semester" value="<?= htmlspecialchars($selected_semester) ?>">
        ...
        <div class="tab-pane fade <?= $active_tab === 'nilai' ? 'show active' : '' ?>" id="nilai" role="tabpanel" aria-labelledby="nilai-tab">
            ...
            <div class="card shadow-sm border-0 rounded-4 mb-4">
                <div class="card-body p-4">
                    ...
                    <div class="d-flex flex-wrap justify-content-between align-items-center gap-2">
                        ...
                        <?php if ($can_lock): ?>
                            <form action="<?= $this->getBaseUrl() ?>/api/v1/ekskul/kunci/nilai" method="POST" class="mb-0">
                                <input type="hidden" name="ekskul_id" value="<?= htmlspecialchars($selected_ekskul_id) ?>">
                                <input type="hidden" name="tahun_ajaran_id" value="<?= htmlspecialchars($active_ta['id'] ?? '') ?>">
                                <input type="hidden" name="semester" value="<?= htmlspecialchars($selected_semester) ?>">
                                <?php if($is_super_admin): ?>
            ...
            <?php else: ?>
                <form action="<?= $this->getBaseUrl() ?>/api/v1/ekskul/nilai/simpan<?= $is_super_admin ? '?tenant_id=' . urlencode($selected_tenant) : '' ?>" method="POST">
                    <input type="hidden" name="ekskul_id" value="<?= htmlspecialchars($selected_ekskul_id) ?>">
                    <input type="hidden" name="tahun_ajaran_id" value="<?= htmlspecialchars($active_ta['id'] ?? '') ?>">
                    <input type="hidden" name="semester" value="<?= htmlspecialchars($selected_semester) ?>">
                    <?php if($is_super_admin): ?>
                    ...
                    <div class="card shadow-sm border-0 rounded-4 overflow-hidden mb-4">
                        <div class="card-header bg-white border-bottom-0 py-3 d-flex justify-content-between align-items-center">
                            ...
                            <div class="d-flex gap-2">
                                <a href="<?= $this->getBaseUrl() ?>/api/v1/ekskul/nilai/export?ekskul_id=<?= urlencode($selected_ekskul_id) ?>&semester=<?= urlencode($selected_semester) ?>&tahun_ajaran_id=<?= urlencode($active_ta['id'] ?? '') ?><?= $is_super_admin ? '&tenant_id=' . urlencode($selected_tenant) : '' ?>" class="btn btn-sm btn-outline-primary <?= empty($nilai_list) ? 'disabled' : '' ?>">
...
<div class="modal fade" id="tambahEkskulModal" tabindex="-1" aria-labelledby="tambahEkskulModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-dialog-scrollable">
    <div class="modal-content">
      <form action="<?= $this->getBaseUrl() ?>/api/v1/ekskul/tambah" method="POST">
...
<div class="modal fade" id="tambahPembinaModal" tabindex="-1" aria-labelledby="tambahPembinaModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-dialog-scrollable">
    <div class="modal-content">
      <form action="<?= $this->getBaseUrl() ?>/api/v1/ekskul/pembina/tambah" method="POST">
          <div class="modal-header">
...
<div class="modal fade" id="editEkskulModal" tabindex="-1" aria-labelledby="editEkskulModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-dialog-scrollable">
    <div class="modal-content">
      <form action="<?= $this->getBaseUrl() ?>/api/v1/ekskul/edit" method="POST">
...
<div class="modal fade" id="editPembinaModal" tabindex="-1" aria-labelledby="editPembinaModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-dialog-scrollable">
    <div class="modal-content">
      <form action="<?= $this->getBaseUrl() ?>/api/v1/ekskul/pembina/edit" method="POST">
...
<div class="modal fade" id="importGradesModal" tabindex="-1" aria-labelledby="importGradesModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-dialog-scrollable">
    <div class="modal-content">
      <form action="<?= $this->getBaseUrl() ?>/api/v1/ekskul/nilai/import" method="POST" enctype="multipart/form-data">
          <input type="hidden" name="ekskul_id" value="<?= htmlspecialchars($selected_ekskul_id) ?>">
          <input type="hidden" name="tahun_ajaran_id" value="<?= htmlspecialchars($active_ta['id'] ?? '') ?>">
          <input type="hidden" name="semester" value="<?= htmlspecialchars($selected_semester) ?>">
          <?php if($is_super_admin): ?>
