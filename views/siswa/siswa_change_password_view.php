...
<head>
    ...
    <title>Wajib Ubah Password - SINTA-SaaS SaaS</title>
    <!-- Google Fonts -->
    <link href="https://fonts.googleapis.com/css2?family=Plus+Jakarta+Sans:wght@400;500;600;700;800&display=swap" rel="stylesheet">
    <!-- Bootstrap Icons -->
    <link href="<?= $this->getBaseUrl() ?>/assets/css/bootstrap-icons.css" rel="stylesheet">
    <!-- Tailwind CSS -->
    <script>
    ...
    <script src="<?= $this->getBaseUrl() ?>/assets/js/tailwindcss.js"></script>
    <!-- Vue 3 -->
    <script src="<?= $this->getBaseUrl() ?>/assets/js/vue.global.prod.js"></script>
    <style>
...
<body class="bg-gradient-to-tr from-slate-50 via-slate-100 to-indigo-50/50 min-h-screen flex items-center justify-center p-4">
    ...
    <div id="siswaChangePasswordApp" v-cloak class="w-full max-w-md">
        ...
        <div class="bg-white rounded-3xl shadow-xl border border-slate-100 p-8">
            ...
            <div class="mt-6 text-center border-t border-slate-100 pt-5">
                <a href="<?= $this->getBaseUrl() ?>/siswa/logout" class="text-xs font-semibold text-slate-500 hover:text-rose-600 transition-colors flex items-center justify-center gap-1.5">
    ...
    <!-- Axios & SweetAlert2 -->
    <script src="<?= $this->getBaseUrl() ?>/assets/js/axios.min.js"></script>
    <script src="<?= $this->getBaseUrl() ?>/assets/js/sweetalert2.all.min.js"></script>
            ...
            Vue.createApp({
                ...
                methods: {
                    handleChangePassword() {
                        ...
                        axios.post('<?= $this->getBaseUrl() ?>/api/v1/siswa/ubah-password', this.form)
                        .then(response => {
                            this.loading = false;
                            if (response.data.success) {
                                Swal.fire({
                                    ...
                                    willClose: () => {
                                        window.location.href = '<?= $this->getBaseUrl() ?>/dashboard';
                                    }
                                });
                            }
                        })
