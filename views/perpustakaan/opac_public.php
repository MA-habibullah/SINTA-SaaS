...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark py-3">
    <div class="container">
        <a class="navbar-brand d-flex align-items-center gap-2 nav-brand-logo" href="<?= $this->getBaseUrl() ?>/perpustakaan/opac">
        ...
        <div class="d-flex gap-2">
            <a href="<?= $this->getBaseUrl() ?>/login" class="btn btn-outline-light btn-sm rounded-pill px-3">
    ...
    <div class="row justify-content-center search-card mb-5">
        <div class="col-12 col-lg-9">
            <div class="card border-0 shadow-lg rounded-4 p-3 p-md-4 bg-white">
                <form method="GET" action="<?= $this->getBaseUrl() ?>/perpustakaan/opac" class="row g-2 align-items-center">
        ...
        <?php if (empty($data['list'])): ?>
            <div class="col-12">
                <div class="card border-0 shadow-sm rounded-4 p-5 text-center bg-white">
                    ...
                    <div>
                        <a href="<?= $this->getBaseUrl() ?>/perpustakaan/opac" class="btn btn-outline-primary rounded-pill px-4">
                            Reset Pencarian
                        </a>
                    </div>
                </div>
                ...
                <div class="col-12 col-md-6 col-lg-4">
                    <div class="card book-card p-3 d-flex flex-column">
                        ...
                        <div class="border-top pt-3 mt-2 d-flex justify-content-between align-items-center">
                            ...
                            <?php if (!empty($book['is_ebook'])): ?>
                                <a href="<?= $this->getBaseUrl() ?>/perpustakaan/baca-ebook" class="btn btn-sm btn-primary rounded-pill px-3 fs-8">
