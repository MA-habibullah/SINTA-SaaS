...
<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-2 pb-2 mb-4 border-bottom">
    ...
    <div class="btn-toolbar gap-2 mb-2 mb-md-0">
        <a href="<?= $this->getBaseUrl() ?>/perpustakaan/opac" target="_blank" class="btn btn-outline-primary btn-sm rounded-3 px-3 py-2 fs-7">
            <i class="bi bi-globe me-1"></i> OPAC Publik
        </a>
        <a href="<?= $this->getBaseUrl() ?>/perpustakaan/sirkulasi" class="btn btn-primary btn-sm rounded-3 px-3 py-2 fs-7">
...
<div class="card border-0 shadow-sm rounded-4 p-4 mb-4">
    ...
    <div class="row g-3">
        <div class="col-12 col-md-4">
            <a href="<?= $this->getBaseUrl() ?>/perpustakaan/katalog" class="card border-0 shadow-sm rounded-3 p-3 text-decoration-none text-dark h-100 hover-elevation">
        ...
        <div class="col-12 col-md-4">
            <a href="<?= $this->getBaseUrl() ?>/perpustakaan/sirkulasi" class="card border-0 shadow-sm rounded-3 p-3 text-decoration-none text-dark h-100 hover-elevation">
                <div class="d-flex align-items-center gap-3">
        ...
        <div class="col-12 col-md-4">
            <a href="<?= $this->getBaseUrl() ?>/perpustakaan/anggota" class="card border-0 shadow-sm rounded-3 p-3 text-decoration-none text-dark h-100 hover-elevation">
                <div class="d-flex align-items-center gap-3">
