<template>
  <div class="min-h-screen bg-slate-50 flex">
    ...
    <!-- 1. Authentic SINTA-SaaS Fixed Left Sidebar -->
    <aside :class="[
      ...
      <div class="flex-grow overflow-y-auto px-3 py-4 space-y-6 select-none scrollbar-thin">
        <div v-for="(group, gIdx) in menuGroups" :key="gIdx" class="space-y-1">
          ...
          <ul class="space-y-0.5">
            <li v-for="menu in group.items" :key="menu.url">
              <a :href="menu.url" 
                 :class="[
...
// SINTA-SaaS Canonical Grouped Menus Hierarchy
const menuGroups = [
  {
    groupName: 'Utama',
    items: [
      { title: 'Dashboard', url: '/dashboard', icon: 'bi bi-grid-fill' },
    ]
  },
  {
    groupName: 'Data Pokok & Siswa',
    items: [
      { title: 'Buku Induk Siswa', url: '/siswa/buku-induk', icon: 'bi bi-people-fill' },
      { title: 'PPDB Calon Siswa', url: '/siswa/ppdb', icon: 'bi bi-person-plus-fill' },
    ]
  },
  {
    groupName: 'Akademik & Penilaian',
    items: [
      { title: 'Master Akademik', url: '/akademik/master', icon: 'bi bi-journal-text' },
      { title: 'Penilaian Rapor', url: '/akademik/penilaian', icon: 'bi bi-award-fill' },
    ]
  },
  {
    groupName: 'Keuangan & Pembayaran',
    items: [
      { title: 'Pos & Tagihan SPP', url: '/keuangan/tagihan', icon: 'bi bi-wallet2' },
      { title: 'Kasir Pembayaran', url: '/keuangan/kasir', icon: 'bi bi-cash-stack' },
    ]
  },
  {
    groupName: 'Layanan Khusus & BK',
    items: [
      { title: 'BK & Konseling', url: '/bk', icon: 'bi bi-heart-pulse-fill' },
      { title: 'PDSS & SNBP', url: '/pdss', icon: 'bi bi-mortarboard-fill' },
      { title: 'Perpustakaan DDC', url: '/perpustakaan', icon: 'bi bi-book-half' },
      { title: 'Persuratan & Disposisi', url: '/persuratan', icon: 'bi bi-envelope-paper-fill' },
      { title: 'Sarana Prasarana (QR)', url: '/sarpras', icon: 'bi bi-box-seam-fill' },
      { title: 'SMK & PKL Mitra', url: '/smk', icon: 'bi bi-buildings-fill' },
  ...
  },
  {
    ...
    items: [
      { title: 'Kepegawaian GTK', url: '/kepegawaian', icon: 'bi bi-person-badge-fill' },
      { title: 'CMS & Pengumuman', url: '/cms', icon: 'bi bi-newspaper' },
      { title: 'Log Aktivitas & Audit', url: '/sistem/activity-logs', icon: 'bi bi-shield-check' },
    ]
  }
];
