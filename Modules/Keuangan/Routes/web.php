...
Route::middleware(['web', 'auth', 'tenant.guard'])->prefix('keuangan')->name('keuangan.')->group(function () {
    ...
    Route::get('/pos-tarif', [MasterKeuanganController::class, 'index'])->name('pos-tarif.index'); // Alias
    ...
    Route::post('/kas-bank', [MasterKeuanganController::class, 'storeKasBank'])->name('kas-bank.store');
    Route::put('/kas-bank/{id}', [MasterKeuanganController::class, 'updateKasBank'])->name('kas-bank.update');
    Route::delete('/kas-bank/{id}', [MasterKeuanganController::class, 'deleteKasBank'])->name('kas-bank.destroy');
    ...
    // 3. Loket Kasir Pembayaran Real-time
    ...
    // 4. Manajemen Tagihan & Batch Invoicing
