...
try {
    ...
    // 2. Buat Global Tenant (ID: 00000000-0000-0000-0000-000000000000)
    ...
    // 3. Buat Role Super Admin Platform
    ...
    $menus = [
        ...
        ['Layanan & Kedisiplinan', '/bk/layanan', 'bi bi-person-badge', 'BIMBINGAN KONSELING'],
