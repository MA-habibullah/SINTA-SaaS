...
class BukuIndukModuleController extends BaseController {
    ...
    public function verifyTranskripApi(): void {
        ...
        try {
            ...
            $siswaModel = new \App\Modules\Siswa\Models\SiswaModel(null);
    ...
    public function storeBeasiswaApi(): void {
        ...
        try {
            ...
            if (empty($tenantId)) {
                $this->jsonResponse(['success' => false, 'error' => 'Tenant sekolah siswa tidak ditemukan.'], 400);
                return;
            }
    ...
    public function deleteBeasiswaApi(): void {
        ...
        try {
            ...
            $dbTenantId = $row['tenant_id'] ?? null;

            if (!$siswaId) {
                $this->jsonResponse(['success' => false, 'error' => 'Data beasiswa tidak ditemukan.'], 404);
                return;
            }
